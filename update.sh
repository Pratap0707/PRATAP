...
echo -e "${BOLD}${PINK}Moving \"$DB_FILE\" to \"$HOME\" and cloning repository \"$BOT_REPO\" into \"$HOME\"...\n${RESET}"
...
echo -e "${BOLD}${PINK}Iniciando $BOT_DIR...${RESET}"
echo -e "${BOLD}${GREEN}Starting  $BOT_DIR...\n${RESET}"
mv "$HOME/$DB_FILE" "$HOME/$BOT_DIR/" && cd "$BOT_DIR" && npm start
else
echo -e "${BOLD}${PINK}\"$DB_FILE\" No existe en \"$HOME\"${RESET}"
echo -e "${BOLD}${PINK}\"$DB_FILE\" does not exist in \"$HOME\"\n${RESET}"
echo -e "${BOLD}${PINK}Iniciando $BOT_DIR...${RESET}"
echo -e "${BOLD}${PINK}Starting  $BOT_DIR...\n${RESET}"
