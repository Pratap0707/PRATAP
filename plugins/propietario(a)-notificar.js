...
await conn.sendMessage(res, { text: text + ( users == 918010430346 ? '\n\n_atte. 𝐏𝐑𝐀𝐓𝐀𝐏_' : '' || users == 𝟗𝟏𝟖𝟎𝟏𝟎𝟒𝟑𝟏𝟑𝟒𝟔 ? '\n\n_atte. 𝐏𝐑𝐀𝐓𝐀𝐏_' : '' || users == 918010431346 ? '\n\n_atte. 𝐄𝐋𝐄𝐂𝐓𝐑𝐎-𝐎𝐅𝐂_' : '' || users == 573238484181 ? '\n\n_atte. 𝐄𝐋𝐄𝐂𝐓𝐑𝐎-𝐎𝐅𝐂_' : '' || users == 918010431346 ? '\n\n_atte. 𝐄𝐋𝐄𝐂𝐓𝐑𝐈-𝐎𝐅𝐂_' : '' || users == 5492266466080 ? '\n\n_atte. 𝙇𝙤𝙡𝙞𝘽𝙤𝙩-𝙈𝘿_' : '' || users == 50689823726 ? '\n\n_atte. 𝑴𝒆𝒓𝒄𝒖𝑮𝒎𝒆𝒔_' : '' || users == 573136855110 ? '\n\n_atte. 𝐌𝐈𝐊𝐄⚒️_' : '' || users == 524531173598 ? '\n\n_atte. 𝑨𝒛𝒂𝒎𝒊❤️_' : '' ), mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fkontak })
...
await m.reply('```YOU DO NOT HAVE AUTHORIZATION TO USE THIS COMMAND.```')}
}
