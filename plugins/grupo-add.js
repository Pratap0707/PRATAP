...
if (text.includes('+')) throw  `${lenguajeGB['smsAvisoMG']()}𝙀𝙉𝙏𝙀𝙍 𝙏𝙃𝙀 𝙉𝙐𝙈𝘽𝙀𝙍 𝘼𝙇𝙇 𝙏𝙊𝙂𝙀𝙏𝙃𝙀𝙍 𝙒𝙄𝙏𝙃𝙊𝙐𝙏 𝙏𝙃𝙀 *+*`
let group = m.chat
let link = 'https://chat.whatsapp.com/' + await conn.groupInviteCode(group)
 
      await conn.reply(text+'@s.whatsapp.net', `Hola! me presento, soy ELECTROBot-MD ⚡y soy un Bot para WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te agregues, te esperamos!!\n\n${link}`, m, {mentions: [m.sender]})
