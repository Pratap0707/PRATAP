...
lugar = official[0][0] == String(contact[0]) ? '🇪🇨 Ecuador' : official[1][0] == String(contact[0]) ? '🇦🇷 Argentina' : official[2][0] == String(contact[0]) ? '🇲🇽 México' : official[3][0] == String(contact[0]) ? '🇮🇳 india' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/pratap0707' : official[1][0] == String(contact[0]) ? 'https://github.com/Devil-08' : official[2][0] == String(contact[0]) ? 'https://github.com' : official[3][0] == String(contact[0]) ? 'https://github.com' : md 
